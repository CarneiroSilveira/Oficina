namespace Views{
    public class ViewDeletarClientes : Form{
        private readonly Form ParentFormDeletarClientes;
        ...
        public ViewDeletarClientes(Form parent){
            ParentFormDeletarClientes = parent;
        ...
        private void ClickFechar(object? sender, EventArgs e){
            Close();
            ParentFormDeletarClientes.Show();
        }
